		...
		<div class="main-ad">
			<ul class="main-ad-list">
				...
				<li class="ma-list-item ma-list-item_price"><i class="mal-item-icon mal-item-icon_dollar"><svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewbox="0 0 24 24" fill="#1E1E1E">
						...
						</svg></i><span class="mal-item-text">Толық курстың бағасы <span class="mali-text-old_price">7 200 тг</span> <span class="ad-price">4 990 </span>теңге <span class="ad-discount">-30%</span></span></li>
				...
				<li class="ma-list-item"><i class="mal-item-icon mal-item-icon_duration"><svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewbox="0 0 24 24" fill="#1E1E1E">
						...
						</svg></i><span class="mal-item-text">10 сабақ (20 минуттан)</span></li>
				<li class="ma-list-item"><i class="mal-item-icon mal-item-icon_cert"><svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewbox="0 0 24 24" fill="#1E1E1E">
						...
						</svg></i><span class="mal-item-text">Онлайн <span class="red-color">сертификат </span></span></li>
			</ul>
		...
		<div class="main-block">
			...
			<div class="main-block-card">
				<div class="mb-card-video" id="video_1">
					...
					<div class="mbc-video-buttons">
						<i class="mbcv-buttons-play">
							<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewbox="0 0 24 24" width="64" height="64" fill="currentColor"><path d="m12,0C5.383,0,0,5.383,0,12s5.383,12,12,12,12-5.383,12-12S18.617,0,12,0Zm0,21c-4.963,0-9-4.038-9-9S7.037,3,12,3s9,4.038,9,9-4.037,9-9,9Zm-3-13.5l8,4.5-8,4.5V7.5Z"></path></svg>
						</i>
				...
				<div class="mb-card-homework">
					<button class="mbc-homework-test" data-name="test-demo">ТЕСТ №1</button>
					<span class="mbc-homework-score" data-name="test-score-1">0%</span>
				</div>
			</div>
			...
			$tests_list = [
				[
					'img_src' => 'img/u1.jpg',
					'title' => 'Главная вкладкасындағы құрал-саймандармен жұмыс жасап үйрену.'
				],
				[
					'img_src' => 'img/u1.jpg',
					'title' => 'Главная вкладкасындағы құрал-саймандармен жұмыс жасап үйрену.'
			...
			@foreach($tests_list as $test_item)
			<div class="main-block-card">
				<div class="mb-card-video">
					<div class="mbc-video-cover">
						<img src="{{ $test_item['img_src'] }}" alt="">
					</div>
					<a class="mbc-video-buttons" href="{{ route('register') }}">
						<i class="mbcv-buttons-play">
							<svg id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewbox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" width="64" height="64" fill="currentColor"><g><path d="M405.333,179.712v-30.379C405.333,66.859,338.475,0,256,0S106.667,66.859,106.667,149.333v30.379   c-38.826,16.945-63.944,55.259-64,97.621v128C42.737,464.214,90.452,511.93,149.333,512h213.333   c58.881-0.07,106.596-47.786,106.667-106.667v-128C469.278,234.971,444.159,196.657,405.333,179.712z M277.333,362.667   c0,11.782-9.551,21.333-21.333,21.333c-11.782,0-21.333-9.551-21.333-21.333V320c0-11.782,9.551-21.333,21.333-21.333   c11.782,0,21.333,9.551,21.333,21.333V362.667z M362.667,170.667H149.333v-21.333c0-58.91,47.756-106.667,106.667-106.667   s106.667,47.756,106.667,106.667V170.667z"></path></g></svg>
						</i>
						<span class="mbcv-buttons-text">Ашу</span>
					</a>
				</div>
				<div class="mb-card-desc">
					<h3 class="mbc-desc-title">№{{ $loop->index + 2}} сабақ.</h3>
					<h2 class="mbc-desc-name">{{ $test_item['title'] }}</h2>
				</div>
				<div class="mb-card-materials">
					<ul class="mbc-materials-list">
						<li class="mbcm-list-item"><a class="mbcml-item-link" href="{{ route('register') }}">Лекция</a></li>
						<li class="mbcm-list-item"><a class="mbcml-item-link" href="{{ route('register') }}">Презентация</a></li>
						<li class="mbcm-list-item"><a class="mbcml-item-link" href="{{ route('register') }}">Практикалық жұмыс</a></li>
					</ul>
				</div>
				<div class="mb-card-homework">
					<a class="mbc-homework-test" href="{{ route('register') }}">ТЕСТ №{{ $loop->index + 2}}</a>
					<span class="mbc-homework-score">0%</span>
				</div>
			</div>
		...
		<div class="test-card">
			<div class="test-card-in">
				...
				<div class="test-card-footer">
					...
					<button class="tc-footer-btn tc-footer-btn_first tc-footer-btn_last d-none" id="testFinishDemo" >Тестті аяқтау</button>
				</div>
